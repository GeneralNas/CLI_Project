...
import com.nasircode.booking.CarBooking;
import com.nasircode.booking.CarBookingDao;
import com.nasircode.booking.CarBookingService;
import com.nasircode.car.Car;
import com.nasircode.car.CarDAO;
import com.nasircode.car.CarService;
import com.nasircode.users.*;
...
public class Main {
    ...
    private static void allBookings(CarBookingService carBookingService) {
        ...
        if (bookings.isEmpty()) {
            System.out.println("No bookings available ☹️");
            return;
        }
